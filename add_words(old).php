...
<div>
    ...
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group mr-2" role="group" aria-label="Second group">
            <button class="main-buttons" type="submit" onClick="addTableRows('word_table')">Add Rows</button>
        </div>
        </div>
        <div class="btn-group mr-2" role="group" aria-label="Third group">
            <button type="submit" class="main-buttons">Add Words</button>
        </div>
    </div>
    <br><br>
        ...
        <script>
            ...
            function addTableRows(word_table) {
               // alert("add rows");
                ...
                var rowTwo = table.insertRow(rowCount);
                var row = table.insertRow(rowCount);

                var colCountTwo = table.rows[0].cells.length;
